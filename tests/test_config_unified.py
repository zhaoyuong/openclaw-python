...
class TestOpenClawConfig:
    ...
    def test_create_with_params(self):
        ...
        config = OpenClawConfig(agent={"model": "anthropic/claude-opus-4"}, gateway={"port": 9000})
    ...
    def test_to_dict(self):
        """Test serialization"""
        config = OpenClawConfig(gateway={"port": 8765})
...
class TestChannelsConfig:
    ...
    def test_get_enabled(self):
        """Test getting enabled channels"""
        config = ChannelsConfig(
            telegram=SingleChannelConfig(enabled=True), discord=SingleChannelConfig(enabled=False)
        )
    ...
    def test_iterate_channels(self):
        ...
        config = ChannelsConfig(
            telegram=SingleChannelConfig(enabled=True), discord=SingleChannelConfig(enabled=True)
        )
