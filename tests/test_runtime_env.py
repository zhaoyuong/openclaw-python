...
class TestRuntimeEnv:
    ...
    def test_lazy_initialization(self):
        ...
        env = RuntimeEnv(env_id="test", model="anthropic/claude-sonnet-4")
    ...
    def test_to_dict(self):
        """Test serialization"""
        env = RuntimeEnv(
            env_id="test", model="anthropic/claude-sonnet-4", config={"temperature": 0.7}
        )
...
class TestRuntimeEnvManager:
    ...
    def test_create_env(self):
        ...
        env = manager.create_env("prod", "anthropic/claude-opus-4")
