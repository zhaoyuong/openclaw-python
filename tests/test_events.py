...
from openclaw.events import Event, EventBus, EventType, get_event_bus, reset_event_bus
...
class TestEvent:
    ...
    def test_create_event(self):
        """Test event creation"""
        event = Event(type=EventType.AGENT_TEXT, source="test-agent", data={"text": "Hello"})
    ...
    def test_event_to_dict(self):
        ...
        event = Event(
            type=EventType.AGENT_TEXT, source="test", session_id="sess-1", data={"text": "Hi"}
        )
