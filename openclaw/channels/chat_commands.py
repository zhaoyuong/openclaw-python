...
class ChatCommandParser:
    ...
    def parse(self, text: str) -> ChatCommand | None:
        """
        ...
        return ChatCommand(name=cmd_name[1:], args=args, raw_text=text)  # Remove leading /
...
class ChatCommandExecutor:
    ...
    async def execute(
        self, command: ChatCommand, session_id: str, user_id: str, is_owner: bool = False
    ) -> str:
        """
